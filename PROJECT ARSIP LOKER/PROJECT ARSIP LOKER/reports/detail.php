...
try {
    ...
    $overall_stats = $db->fetch("
        ...
        WHERE created_by = ?
    ", [$user_id]);
    $document_stats['overall_total'] = $overall_stats['total'] ?? 0;
                    ...
                    <div class="card-body">
                        <form class="row g-3 align-items-end" method="GET">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <input type="date" class="form-control" id="date" name="date" value="<?php echo $selected_date->format('Y-m-d'); ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card text-white bg-primary mb-3 shadow-sm">
                                    <div class="card-body">
                                        <p class="card-title text-uppercase small mb-1">Total Dokumen (Tanggal)</p>
                                        <h3 class="card-text mb-0">
                                            <?php echo number_format($document_stats['total'] ?? 0); ?>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card text-white bg-success mb-3 shadow-sm">
                                    <div class="card-body">
                                        <p class="card-title text-uppercase small mb-1">Dokumen Aktif (Tanggal)</p>
                                        <h3 class="card-text mb-0">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-end">
                                    ...
                                    <span class="text-muted small">Seluruh dokumen pada tanggal ini</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <?php if (empty($documents)): ?>
                                    <p class="text-muted mb-0">Belum ada dokumen yang dibuat oleh user ini.</p>
                                <?php else: ?>
                                            ...
                                            <tbody>
                                                <?php foreach ($documents as $document): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($document['full_name']); ?></td>
                                                        <td><?php echo e($document['citizen_category'] ?? '-'); ?></td>
                                                        <td>
                                                            <?php if ($document['status'] === 'active'): ?>
                                                                <span class="badge bg-success">Active</span>
                                                            <?php else: ?>
                                                                <span class="badge bg-secondary"><?php echo e(ucfirst($document['status'])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
