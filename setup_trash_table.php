...
try {
    ...
    $conn->exec($sql1);
    echo "✓ Tabel document_trash berhasil dibuat<br>";
    ...
    $conn->exec($sql2);
    echo "✓ Tabel trash_audit_logs berhasil dibuat<br>";

    echo "<br><strong style='color: green;'>✓ Setup tabel trash berhasil!</strong>";
